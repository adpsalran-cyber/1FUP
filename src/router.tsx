...
function getConditionBadge(formVal: any) {
  // Supporta sia stringhe ('in_forma', 'infortunato', ecc.) sia valori numerici (-1, 0, 1)
      ...
      <div className="space-y-4">
        {players?.map((player: any) => {
          ...
          return (
            ...
            >
              {/* Riga Superiore: OVR + Ruolo a sinistra, FRECCIA FORMA a destra */}
              ...
              {/* Parametri di Squadra e Portiere (senza Presenze/Vittorie/MVP) */}
